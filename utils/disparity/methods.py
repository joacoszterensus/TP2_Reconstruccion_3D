...
class Calibration:
    def __init__(
        ...
        left_image_rect_normalized: np.ndarray = None,
        comment: str = "",
    ):
        self.width = width
        self.height = height
        ...
        if not left_image_rect_normalized:
            left_image_rect_normalized = np.array([0.0, 0.0, 1.0, 1.0])
        self.left_image_rect_normalized = left_image_rect_normalized
